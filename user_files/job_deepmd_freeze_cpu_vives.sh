...
#fi
SCRATCH=/storage/scratch/lv87/lv87908/job_dir #Elia's scratch
...
#if [ "${SLURM_JOB_QOS:4:3}" == "cpu" ]; then #Adrian: Changed gpu by thin
...
LAUNCH_CMD="${SRUN_DeepMD_EXE} freeze -o ${DeepMD_MODEL_FILE} ${log}"
